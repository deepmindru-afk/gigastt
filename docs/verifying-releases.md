...
```sh
gh release download v2.3.0 -R ekhodzitsky/gigastt \
...
minisign -Vm gigastt-2.3.0-aarch64-apple-darwin.tar.gz -p gigastt.pub
```
...
```sh
gh attestation verify gigastt-2.3.0-aarch64-apple-darwin.tar.gz \
