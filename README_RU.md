...
| Движок | Чистая | Far-field | Телефон | YouTube | RTF | Диск | Пик RAM | Холодный старт | Стриминг |
|---|--:|--:|--:|--:|--:|--:|--:|--:|---|
| **gigastt** (GigaAM v3 `rnnt`) | 3.55 | **4.08** | **18.50** | **10.91** | 0.10 | ~225 МБ | 790 / ~400 МБ | **0.94 с** | **Да** — инкр. WS |
| Vosk 0.54 (Zipformer2) | **2.97** | 6.29 | 22.74 | 17.24 | ~0.03 | 966 МБ | 560 МБ | 1.16 с | Да (сервер) |
| T-one (beam + LM) | 6.61 | 14.62 | 21.73 | 23.23 | 0.065 | 138 МБ + 5.5 ГБ LM | — | — | Да (300 мс) |
| T-one (greedy, без LM) | 7.85 | 17.22 | 22.37 | 26.54 | 0.065 | 138 МБ | 672 МБ | 1.87 с | Да (300 мс) |
| whisper.cpp (Large v3) | 15.26 | 17.91 | 32.73 | 22.61 | 0.36–0.77 | 2.9 ГБ | — | — | Нет |
| faster-whisper (Large v3) | 15.53 | 17.34 | 24.93 | 15.45 | &gt;1.0 | 2.9 ГБ | 2619 МБ | 8.2 с | Нет |
| faster-whisper-turbo | 14.45 | 18.30 | 26.58 | 15.45 | &gt;1.0 | 1.6 ГБ | 2154 МБ | 6.8 с | Нет |
...
| Экспорт | JSON · TXT · SRT · VTT · Markdown (потоковые тайминги + confidence) |
