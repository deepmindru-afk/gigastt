...
|---|---|---|---|---|---|---|
| gigastt | GigaAM v3 (INT8) | *в процессе* | *в процессе* | *в процессе* | *в процессе* | 230 МБ |
| whisper.cpp | Whisper Large v3 | *в процессе* | *в процессе* | *в процессе* | *в процессе* | ~3 ГБ |
| faster-whisper | Whisper Large v3 (INT8) | *в процессе* | *в процессе* | *в процессе* | *в процессе* | ~3 ГБ |
| Vosk | vosk-model-ru-0.42 | *в процессе* | *в процессе* | *в процессе* | *в процессе* | 1.3 ГБ |

> **Ожидаемый нарратив:** smoke-прогоны уже показывают, что Vosk лидирует на
> чистой начитке, gigastt — на дальнем микрофоне, а движки на базе Whisper
> становятся конкурентоспособными на спонтанной/шумной речи. Полные цифры
> заменят заглушки выше. Полная методология и подготовка датасетов:
